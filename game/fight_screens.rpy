    ...
    fixed:
        ...
        vbox:
            ...
            fixed:
                ...
                bar value cien_hp_now range cien_hp xsize 200 ysize 14:
                    left_bar Solid(
                ...
                text "[cien_hp_now]/[cien_hp]" size 12 color "#ffffff" outlines [(1, "#00000080", 0, 0)] xalign 0.5 yalign 0.5
    ...
    fixed:
        ...
        vbox:
            ...
            fixed:
                ...
                bar value policja1_hp_now range policja1_hp xsize 200 ysize 14:
                    left_bar Solid(
                ...
                text "[policja1_hp_now]/[policja1_hp]" size 12 color "#ffffff" outlines [(1, "#00000080", 0, 0)] xalign 0.5 yalign 0.5

            text "ATK: [policja1_min_attack_now]-[policja1_max_attack_now]" style "dmg_text" xalign 0.5
    ...
    fixed:
        ...
        vbox:
            ...
            fixed:
                ...
                bar value policja2_hp_now range policja2_hp xsize 200 ysize 14:
                    left_bar Solid(
                ...
                text "[policja2_hp_now]/[policja2_hp]" size 12 color "#ffffff" outlines [(1, "#00000080", 0, 0)] xalign 0.5 yalign 0.5

            text "ATK: [policja2_min_attack_now]-[policja2_max_attack_now]" style "dmg_text" xalign 0.5
