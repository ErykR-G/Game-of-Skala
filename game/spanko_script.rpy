    ...
    label spanko_bed:
        ...
        if bralus == 1:
            ...
            if jabole == 0:
                $ ile_item += 1
            $ jabole += 12
            "{i}*Jabole x 12 zostały dodane do ekwipunku*{/i}"

            luszcz "(Najwyraźniej Braun pozbywa się swojego asortymentu z monopolowego i część wysłał mi)"
            luszcz "(mega miłe, napewno skorzystam)"
